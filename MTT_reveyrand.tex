...
\bstctlcite{IEEEexample:BSTcontrol}
    \title{Experimento 1 – Analise de circuitos no domínio da frequência }
  \author{Felipe~Alcântara,~\IEEEmembership{Student Member,~IEEE,}
      and~~Tales~Mauricio,~\IEEEmembership{Member,~IEEE,}\\
      % <-this % stops a space
...
\IEEEPARstart{E}{ste} documento apresenta o relatório  do segundo experimento, da matéria Prática de Circuitos Eletrônicos. Esta atividade teve o objetivo realizar a análise de circuitos no domínio da frequência.
...
\begin{figure}
	\begin{center}
	\includegraphics[scale=0.5]{PDF/123.png}
	\end{center}
\end{figure}
% =======
% FIG. 01
